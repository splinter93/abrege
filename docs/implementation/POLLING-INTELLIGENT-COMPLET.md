...
### **✅ CRÉATION (INSERT)**
- `POST /api/ui/note/create` → Détecté ✅
- `POST /api/ui/folder/create` → Détecté ✅
- `POST /api/ui/notebook/create` → Détecté ✅

### **✅ MODIFICATION (UPDATE)**
- `PUT /api/ui/note/{ref}` → Détecté ✅
- `PUT /api/ui/folder/{ref}` → Détecté ✅
- `PUT /api/ui/notebook/{ref}` → Détecté ✅
- `PATCH /api/ui/note/{ref}/add-content` → Détecté ✅
- `PATCH /api/ui/note/{ref}/information` → Détecté ✅

### **✅ SUPPRESSION (DELETE)**
- `DELETE /api/ui/note/{ref}` → Détecté ✅
- `DELETE /api/ui/folder/{ref}` → Détecté ✅
- `DELETE /api/ui/notebook/{ref}` → Détecté ✅

### **✅ DÉPLACEMENT (MOVE)**
- `PATCH /api/ui/note/{ref}/move` → Détecté ✅
- `PATCH /api/ui/dossier/{ref}/move` → Détecté ✅

### **✅ RENOMMAGE (RENAME)**
- `PUT /api/ui/note/{ref}` (source_title) → Détecté ✅
- `PUT /api/ui/folder/{ref}` (name) → Détecté ✅
- `PUT /api/ui/notebook/{ref}` (name) → Détecté ✅
