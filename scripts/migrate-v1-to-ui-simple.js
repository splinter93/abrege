...
/**
 * Script de migration simple : /api/v1/ → /api/ui/
...
const IGNORE_PATTERNS = [
  ...
  'build',
  'coverage',
  'scripts/migrate-v1-to-ui-simple.js'
];
...
function processFile(filePath) {
  try {
    ...
    // Vérifier si le fichier contient des références à /api/v1/
 ...
 */
function main() {
  console.log('🚀 Début de la migration /api/v1/ → /api/ui/');
  console.log('================================================');
  ...
  if (remainingV1Refs.length === 0) {
    console.log('✅ Aucune référence à /api/v1/ restante !');
  } else {
    console.log(`⚠️  ${remainingV1Refs.length} fichiers contiennent encore des références à /api/v1/`);
