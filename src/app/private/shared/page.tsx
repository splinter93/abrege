...
export default function SharedNotesPage() {
  return (
    <ErrorBoundary>
      <AuthGuard>
        <UnifiedPageLayout className="page-shared">
            ...
            <div className="page-title-content">
              <div className="page-title-left-section">
                ...
                <div className="page-title-section">
                  <h1 className="page-title">Notes Partagées</h1>
                  <p className="page-subtitle">Découvrez et partagez des connaissances</p>
                </div>
              </div>
              <div className="page-title-stats">
                ...
                <div className="page-title-stats-item">
                  <span className="page-title-stats-number">0</span>
                  <span className="page-title-stats-label">partages</span>
                </div>
              </div>
            </div>
          </motion.div>
