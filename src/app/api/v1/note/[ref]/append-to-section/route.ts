...
export async function PATCH(req: NextRequest, { params }: any): Promise<Response> {
  ...
  try {
    ...
    const newContent = appendToSection(markdown, body.section, body.text, body.position || 'end');
...
/**
 * Endpoint: PATCH /api/v1/note/[ref]/append-to-section
 ...
 * - Valide le paramètre ref et le payload avec Zod
 ...
 *   - 422 : { error: 'Paramètre note_ref invalide' | 'Payload invalide' | 'text non autorisé', details }
 *   - 500 : { error: string }
 */ 