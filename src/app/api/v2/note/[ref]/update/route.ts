...
export async function PUT(
  ...
  try {
    ...
    if (validatedData.source_title !== undefined) updateData.source_title = validatedData.source_title;
    if (validatedData.markdown_content !== undefined) updateData.markdown_content = validatedData.markdown_content;
    if (validatedData.html_content !== undefined) updateData.html_content = validatedData.html_content;
    if (validatedData.header_image !== undefined) updateData.header_image = validatedData.header_image;
    if (validatedData.folder_id !== undefined) updateData.folder_id = validatedData.folder_id;
