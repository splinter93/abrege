  ...
  return (
    <div className="editor-toolbar" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
      ...
      <div className="toolbar-group">
        <Tooltip text="Gras (Ctrl+B)"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleBold().run()} aria-label="Gras"><FiBold size={18} /></button></Tooltip>
        <Tooltip text="Italique (Ctrl+I)"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleItalic().run()} aria-label="Italique"><FiItalic size={18} /></button></Tooltip>
        <Tooltip text="Souligné (Ctrl+U)"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleUnderline().run()} aria-label="Souligné"><FiUnderline size={18} /></button></Tooltip>
      </div>
      <div className="toolbar-group">
        <Tooltip text="Aligner à gauche"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().setTextAlign('left').run()} aria-label="Aligner à gauche"><FiAlignLeft size={18} /></button></Tooltip>
        <Tooltip text="Centrer"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().setTextAlign('center').run()} aria-label="Centrer"><FiAlignCenter size={18} /></button></Tooltip>
        <Tooltip text="Aligner à droite"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().setTextAlign('right').run()} aria-label="Aligner à droite"><FiAlignRight size={18} /></button></Tooltip>
        <Tooltip text="Justifier"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().setTextAlign('justify').run()} aria-label="Justifier"><FiAlignJustify size={18} /></button></Tooltip>
      </div>
      <div className="toolbar-group">
        <Tooltip text="Titre 1 (H1)"><button className={`toolbar-button${editor?.isActive && editor.isActive('heading', { level: 1 }) ? ' active' : ''}`} disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleHeading({ level: 1 }).run()} aria-label="Titre 1 (H1)">H1</button></Tooltip>
        <Tooltip text="Titre 2 (H2)"><button className={`toolbar-button${editor?.isActive && editor.isActive('heading', { level: 2 }) ? ' active' : ''}`} disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleHeading({ level: 2 }).run()} aria-label="Titre 2 (H2)">H2</button></Tooltip>
        <Tooltip text="Titre 3 (H3)"><button className={`toolbar-button${editor?.isActive && editor.isActive('heading', { level: 3 }) ? ' active' : ''}`} disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleHeading({ level: 3 }).run()} aria-label="Titre 3 (H3)">H3</button></Tooltip>
      </div>
      <div className="toolbar-group">
        <Tooltip text="Liste à puces"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleBulletList().run()} aria-label="Liste à puces"><FiList size={18} /></button></Tooltip>
        <Tooltip text="Liste numérotée"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleOrderedList().run()} aria-label="Liste numérotée"><AiOutlineOrderedList size={18} /></button></Tooltip>
        <Tooltip text="Cases à cocher"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleTaskList().run()} aria-label="Cases à cocher"><FiCheckSquare size={18} /></button></Tooltip>
      </div>
      <div className="toolbar-group">
        <Tooltip text="Insérer un tableau"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()} aria-label="Insérer un tableau"><MdGridOn size={18} style={{ borderRadius: 4 }} /></button></Tooltip>
        <Tooltip text="Citation"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleBlockquote().run()} aria-label="Citation"><MdFormatQuote size={18} /></button></Tooltip>
        <Tooltip text="Bloc de code"><button className="toolbar-button" disabled={isReadonly} onClick={() => (editor?.chain() as any)?.focus().toggleCodeBlock().run()} aria-label="Bloc de code"><FiCode size={18} /></button></Tooltip>
      </div>
      <div className="toolbar-group">
