...
const FolderManagerDossier: React.FC<FolderManagerDossierProps> = ({ classeurId, dossierId, dossierName }) => {
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(ellipse at 60% 0%, rgba(60,60,80,0.22) 0%, rgba(20,20,28,0.92) 70%),\n                linear-gradient(120deg, rgba(255,255,255,0.04) 0%, rgba(255,106,0,0.06) 100%)`,
