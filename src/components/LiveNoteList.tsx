 ...
 * 
 * ✅ OPTIMISATION : Virtualisation si > 20 items (conforme GUIDE-EXCELLENCE-CODE.md)
 *
 * Utilisation :
 *   <LiveNoteList />
 */
export default function LiveNoteList() {
  ...
  const shouldVirtualize = noteList.length > 20;
  ...
  return (
    <div style={{ maxWidth: 420, margin: '32px auto', padding: 24, background: 'rgba(255,255,255,0.04)', borderRadius: 12 }}>
      ...
      <div style={{ marginTop: 18, fontSize: 13, color: '#888' }}>
        ...
        {shouldVirtualize && <><br /><b>Virtualisé</b> : {noteList.length} items, seulement les visibles sont rendus.</>}
      </div>
    </div>
  );
} 